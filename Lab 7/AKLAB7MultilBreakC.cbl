      ...
      *
           SELECT STUDENT-REPORT-FILE
               ASSIGN TO PRINTER "L8OUTPUT.TXT".
      *
       DATA DIVISION.
       FILE SECTION.
      *
      ...
      *
       01  STUDENT-RECORD.
           ...
           05  SR-NAME                         PIC X(20).
           05  SR-GRADE-ARRAY OCCURS 4 TIMES.
               10  SR-TEST                     PIC 9(3).
           05  FILLER                          PIC X(39).
      ...
      *
       01  DETAIL-LINE.
           ...
           05  DL-NAME                     PIC X(20).
           05                              PIC X(7).
           05  DL-GRADE-ARRAY OCCURS 4 TIMES.
               10  DL-TEST                 PIC XXX.
      ...
      *  This prints the column headers
       ...
       700-PROCESS-STUDENT-RECORD.
           ...
           PERFORM VARYING SUB FROM 1 BY 1 UNTIL SUB > 4
              MOVE SR-TEST(SUB) TO DL-TEST(SUB)
              ADD SR-TEST(SUB) TO DF-TEST-TOTAL
           END-PERFORM
